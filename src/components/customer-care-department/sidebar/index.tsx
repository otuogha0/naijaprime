...
import { customerCarePanelItems } from "@/constants";
import ExitIcon from "../../../../public/assets/exit-icon.svg";
import NaijaPrimeLogo from "../../../../public/assets/NaijaPrimeLogo.svg";
import SidebarBgImg from "../../../../public/assets/cc-sidebar-bg-img.svg";
import CCBGImg from "../../../../public/assets/fd-bg.svg";
...
export const Sidebar = ({ children }: SidebarProps) => {
  ...
  useEffect(() => {
    const activePanelIndex = customerCarePanelItems.findIndex(
  ...
  const homePageBg = {
    backgroundImage: `url(${CCBGImg.src})`,
    backgroundSize: "cover",
    backgroundPosition: "center",
  };
  ...
  return (
    <>
      <div
        className="fixed min-h-screen h-full bg-[#2e3b54] sm:w-[24%] lg:w-[20%]"
        style={styles}
      >
        <div className="flex flex-col h-full w-full">
          <div className="flex justify-center items-center bg-[#3f4b63]">
            <Image
              src={NaijaPrimeLogo}
              width={60}
              height={60}
          ...
          <div className="flex flex-col gap-1 pt-[6rem] w-full">
            {customerCarePanelItems?.map((panelItem, panelIndex) => (
              <Link
                href={`/${panelItem.url}`}
                key={panelIndex}
                className="w-full"
