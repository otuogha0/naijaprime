...
// import MsgIcon from "../../../../../public/assets/msg-icon.svg";
import { Application } from "@/types";
import { useAppSelector } from "@/redux/hooks";
import { fetchShortlistedApplications } from "@/redux/application/actions";

interface ShortlistedContentProps {
  applications: Application[];
}

export const ShortlistedTabContent = ({
  applications = [],
}: ShortlistedContentProps) => {
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 text-end">
              <span className="bg-[#53fe6d] text-[#000] text-[0.938rem] font-manrope font-semibold w-[7rem] h-[1.5rem] inline-block text-center">
                Shortlisted
              </span>
            </div>
          </div>
...
{
  /* {content.shortlisted_status && activeRow === index ? (
