...
export const InProcessTabContent = () => {
  ...
  const inProgressApplications = allApplications.filter(
    (app: any) =>
  ...
  return (
    <>
      {inProgressApplications?.map((content: any, index: number) => (
        <div
          key={index}
